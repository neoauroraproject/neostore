...
export function SellerShell({
  ...
  const nav: NavItem[] = [
    ...
    { href: `${base}/inventory`, label: 'Inventory', icon: 'download' },
    { href: `${base}/extensions`, label: 'Extensions', icon: 'spark' },
    { href: `${base}/orders`, label: 'Orders', icon: 'check' },
    { href: `${base}/appearance`, label: 'Appearance', icon: 'spark' },
    { href: `${base}/homepage`, label: 'Homepage', icon: 'spark' },
    { href: `${base}/tickets`, label: 'Tickets', icon: 'user' },
